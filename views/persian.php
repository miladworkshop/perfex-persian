								...
								<div role="tabpanel" class="tab-pane ptop10" id="assistant">
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-12">
												<a href="javascript:void(0)" onclick="persian_email_theme(); return false;" class="btn btn-primary persian-float-left">راست چین و بهینه سازی</a>
												<span style="font-weight:bold;">راست چین و بهینه سازی قالب ایمیل [ Email Theme ]</span>
												<br /><br />با کلیک روی دکمه " راست چین و بهینه سازی " قالب کلیه ایمیل‌های ارسالی سیستم راست چین و بهینه سازی خواهد شد.
											</div>
											...
											<ul class="persian-timeline">
												<li>
													...
													<div class="persian-timeline-content">
														...
														<p>افزوده شدن راست چین و بهینه ساز قالب ایمیل‌های سیستم به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل یکت ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل پیش فاکتور ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل راردادها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل فاکتور ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل اشتراک ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل یادداشت اعتباری به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل وظایف به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل مشتری ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل پروپوزال ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل روژه‌ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل کاربران کارمند به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل مشتریان احتمالی به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل درخواست پیش فاکتور به دستیار توسعه پارسی</p>
														<p>افزوده شدن فارسی ساز ایمیل نوتیفیکیشن ها به دستیار توسعه پارسی</p>
														<p>افزوده شدن پیامک " ایجاد پروژه جدید ( ارسال به مشتری ) " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد پروژه جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد فاکتور جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد پروپوزال جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد پیش فاکتور جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد قرارداد جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد تیکت جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد یادداشت جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد مشتری احتمالی / بالقوه <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تغییر وضعیت پروژه <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تغییر وضعیت وظیفه <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تغییر وضعیت فاکتور " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " هنگام تغییر وضعیت مشتری احتمالی / بالقوه <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تغییر وضعیت تیکت <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تایید پروپوزال <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " رد / عدم تایید پروپوزال <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تایید پروپوزال <small>( ارسال به مدیر / کارمند )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " رد / عدم تایید پروپوزال <small>( ارسال به مدیر / کارمند )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تایید پیش فاکتور <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " رد / عدم تایید پیش فاکتور " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " تایید پیش فاکتور <small>( ارسال به مدیر / کارمند )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " رد / عدم تایید پیش فاکتور <small>( ارسال به مدیر / کارمند )</small> " به سیستم پیامکی</p>
														<p>افزوده شدن پیامک " ایجاد مخاطب جدید <small>( ارسال به مشتری )</small> " به سیستم پیامکی</p>
													</div>
												</li>
												<hr />
												<li>
...
function persian_email_theme()
{
	...
	$.post(admin_url + 'persian/email_theme', {
        data: post_data
    }).done(function() {
        var tab 		= $('#persian_area').find('li.active > a:eq(0)').attr('href');
        tab 			= tab.substring(1, tab.length)
