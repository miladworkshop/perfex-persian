document.addEventListener('DOMContentLoaded', function()
{
	...
	$('.persian-datepicker').attr('persian-date', '');

	persianDatepicker.startWatch({})
});

function persian_fix(str)
{
	//str = str.replace(/-/g, '/');
...
! function () {
	...
	! function () {
		...
		var e = function (t) {
			...
			J = "today",
			W = "attr",
			q = "persian-date-only-date",
			F = "persian-date-only-time",
			...
			vt = {
				init: function (t) {
					...
					this.updateOptions(t), window.onresize = _t, this.options.autoHide && (document.body.onclick = wt), this.options.autoShow && (n = this.options.selector, Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector, document.body.addEventListener(R, (function (t) {
						t.target.value = persian_fix(t.target.value);
				...
				get initDate() {
					this.input.value = persian_fix(this.input.value);
